  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="" style="font-size: 18px;color: #ac2925;">猫眼电影后台管理系统</a>
      </div>
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2020 <a href="http://piaofang.maoyan.com/dashboard" target="_blank">【猫眼】</a>. All right reserved</p>
