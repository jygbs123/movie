...
import com.demo.movie.dao.admin.DatabaseBakDao;
...
import com.demo.movie.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${movie.database.backup.dir}")
	private String backUpDir;
	@Value("${movie.database.backup.username}")
	private String dbUsername;
	@Value("${movie.database.backup.password}")
	private String dbPwd;
	@Value("${movie.database.backup.database.name}")
